...
Durante o projeto, fiquei responsável pelo desenvolvimento técnico de várias features e dei suporte à equipe em seus desenvolvimentos quando necessário. Também elaborei a identidade visual e o layout das telas do app, elaborando todo o design do protótipo de alta fidelidade da aplicação.


<div align="center">
  <img width="1365" alt="Captura de Tela 2024-10-12 às 17 16 08" src="https://github.com/user-attachments/assets/5a16631a-9d9d-42ee-ad0c-10006f379ace">
  <img width="622" alt="Captura de Tela 2024-10-12 às 17 15 31" src="https://github.com/user-attachments/assets/1ff067cf-7f3a-4c8c-8986-30014a55fae9">
  <img width="418" alt="Captura de Tela 2024-10-12 às 17 15 19" src="https://github.com/user-attachments/assets/ea5488fe-3dce-411d-95be-7a14a4d7aa91">
  <img width="444" alt="Captura de Tela 2024-10-12 às 17 48 11" src="https://github.com/user-attachments/assets/e66d8a55-7af1-4ec9-9d45-0d00638ad4df">
</div>
...
Nesse projeto, foram desenvolvidas as seguintes habilidades:
  ...
  - Utilização de ferramentas para gerenciamento de estado global da aplicação (Redux ou Context API)
  - Gerenciamento de estado dos componentes
  - Elaboração de layout e identidade visual do projeto (todas as telas e com responsividade para todos os tamanhos de tela)
  - Apresentação de protótipo na entrega do projeto
  - Utilização do React Hook useState
  - Utilização do React Hook useContext
  - Utilização do React Hook useEffect
  - Criação de Hooks customizados
  - Escrita de testes automatizados da aplicação
